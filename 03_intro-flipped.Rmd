...
new_names_pre <- c("timestamp", "tools_coder", "tools_models", 
                   ...
                   "subset_experience",
                   "projects_experience", 
                   "reproducible_experience", "self_help_experience",
                   "search_help_experience", "apply_learning_experience",
...
```{r big picture, fig.height=17, fig.width=12, message=FALSE, warning=FALSE}
pre_post_tbl %>% 
